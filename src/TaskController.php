...
class TaskController
{
    ...
    public function processRequest(string $method, ?string $id): void
    {
        if ($id === null) {
            ...
            if ($method == "GET") {
                ...
                if (!empty($errors)) {
                    $this->respondUnprocessableEtity($errors);
                    return;
                }
    ...
    private function respondUnprocessableEtity(array $errors): void
    {
    ...
    private function respondCreated(string $id): void
    {
        ...
        echo json_encode(["message" => "Task is created successfully.", "id" => $id]);
    }
